...
class Database extends Dexie {
    ...
    constructor() {
        ...
        this.version(1).stores({
            ...
            uoms: '[product+name], product',
            indents: '&variableName',
            indentItems: '[indent+product], indent',
            suppliers: '&variableName',
            supplierProducts: '[supplier+product], supplier',
            quotations: '&variableName',
            quotationItems: '[quotation+indentItem], quotation',
            purchaseOrders: '&variableName',
            purchaseOrderItems: '[purchaseOrder+quotationItem], purchaseOrder',
            purchaseInvoices: '&variableName',
            purchaseInvoiceItems: '[purchaseInvoice+purchaseOrderItem], purchaseInvoice',
            materialApprovalSlips: '&variableName',
            materialApprovalSlipItems: '[materialApprovalSlip+PurchaseInvoiceItem], materialApprovalSlip',
            materialRejectionSlips: '&variableName',
            materialRejectionSlipItems: '[materialRejectionSlip+purchaseInvoiceItem], materialRejectionSlip',
            materialReturnSlips: '&variableName',
            materialReturnSlipItems: '[materialReturnSlip+materialRejectionSlipItem], materialReturnSlip',
            materialRequistionSlips: '&variableName',
            materialRequistionSlipItems: '[materialRequistionSlip+materialApprovalSlipItem], materialRequistionSlip',
            boms: '&variableName',
            bomItems: '[bom+product], bom',
            productionPreparationSlips: '&variableName',
            productionPreparationSlipItems: '[productionPreparationSlip+bomItem], productionPreparationSlip',
