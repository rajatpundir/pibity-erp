...
class Database extends Dexie {
    ...
    constructor() {
        ...
        this.version(1).stores({
            ...
            uoms: '&variableName, parent',
            indents: '&variableName',
            indentItems: '&variableName, parent',
            suppliers: '&variableName',
            supplierProducts: '&variableName, supplier, product',
            quotations: '&variableName',
            quotationItems: '&variableName, parent',
            purchaseOrders: '&variableName',
            purchaseOrderItems: '&variableName, parent',
            purchaseInvoices: '&variableName',
            purchaseInvoiceItems: '&variableName, parent',
            materialApprovalSlips: '&variableName',
            materialApprovalSlipItems: '&variableName, parent',
            materialRejectionSlips: '&variableName',
            materialRejectionSlipItems: '&variableName, parent',
            materialReturnSlips: '&variableName',
            materialReturnSlipItems: '&variableName, parent',
            materialRequistionSlips: '&variableName',
            materialRequistionSlipItems: '&variableName, parent',
            boms: '&variableName',
            bomItems: '&variableName, parent',
            productionPreparationSlips: '&variableName',
            productionPreparationSlipItems: '&variableName, parent',
