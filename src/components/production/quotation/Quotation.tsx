...
import * as Grid from './grids/Quotation'
import * as Grid2 from './grids/Quotations'
    ...
    switch (action[0]) {
        ...
        case 'items': {
            switch (action[1]) {
                ...
                case 'addVariable': {
                    state.items.variables = state.items.variables.add(new QuotationItemVariable('', { quotation: new Quotation(state.items.variable.values.quotation.toString()), indentItem: new IndentItem(state.items.variable.values.indentItem.toString()), quantity: 0 }))
        ...
        <>
            <Container area={none} layout={Grid.layouts.main}>
                <Item area={Grid.header}>
                    <Title>Create {quotation.name}</Title>
                </Item>
                ...
                <Container area={Grid.details} layout={Grid.layouts.details}>
                    ...
                    <Item>
                        ...
                        <Input type='text' onChange={onVariableInputChange} value={state.variable.values.supplier.toString()} name='supplier' />
                    </Item>                                   
                </Container>
