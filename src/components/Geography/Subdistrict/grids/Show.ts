...
export const postalCodeArea: GridArea = new GridArea('postalCodeArea')
...
Vector.of(postalCodeArea, postalCodeArea)
...
Vector.of(postalCodeArea, postalCodeArea, postalCodeArea)
...
Vector.of(none, postalCodeArea, postalCodeArea, postalCodeArea, postalCodeArea, none)
