...
export const districtArea: GridArea = new GridArea('districtArea')
...
Vector.of(districtArea, districtArea)
...
Vector.of(districtArea, districtArea, districtArea)
...
Vector.of(none, districtArea, districtArea, districtArea, districtArea, none)
