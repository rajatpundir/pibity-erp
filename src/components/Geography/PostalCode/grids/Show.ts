...
export const addressArea: GridArea = new GridArea('addressArea')
...
Vector.of(addressArea, addressArea)
...
Vector.of(addressArea, addressArea, addressArea)
...
Vector.of(none, addressArea, addressArea, addressArea, addressArea, none)
