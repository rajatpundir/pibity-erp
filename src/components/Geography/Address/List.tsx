...
import { AddressRow, DiffRow } from '../../../main/rows'
import { AddressVariable } from '../../../main/variables'
...
const initialState: State = {
    ...
    offset: 0,
    page: 1,
    columns: Vector.of(['values', 'postalCode', 'values', 'name'], ['values', 'line1'], ['values', 'line2'], ['values', 'latitude'], ['values', 'longitude'])
}
...
function Component(props) {
    ...
    const rows = useLiveQuery(() => db.Address.orderBy('id').toArray())
    ...
    return (
        <Container area={none} layout={Grid.layouts.main} className='p-10'>
            <Item area={Grid.header} align='center' className='flex'>
                ...
                <button onClick={() => { props.history.push('/address') }} className='text-3xl font-bold text-white bg-gray-800 rounded-md px-2'>+</button>
            </Item>
