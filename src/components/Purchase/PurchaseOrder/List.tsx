...
import { PurchaseOrderRow } from '../../../main/rows'
...
function Component(props) {
    ...
    const queriedVariables = useLiveQuery(() => db.purchaseOrders.toArray())
    const variables = (queriedVariables ? queriedVariables.map(x => PurchaseOrderRow.toVariable(x)) : []).filter(variable => applyFilter(state.query, variable))
