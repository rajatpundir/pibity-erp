...
export const purchaseOrderItemArea: GridArea = new GridArea('purchaseOrderItemArea')
    ...
    main: validateLayout({
        ...
        layout_mobile: {
            ...
            areas: Vector.of(
                ...
                Vector.of(details),
                Vector.of(button),
Vector.of(purchaseOrderItemArea)
...
Vector.of(purchaseOrderItemArea, purchaseOrderItemArea)
...
Vector.of(purchaseOrderItemArea, purchaseOrderItemArea, purchaseOrderItemArea)
...
Vector.of(none, purchaseOrderItemArea, purchaseOrderItemArea, purchaseOrderItemArea, purchaseOrderItemArea, none)
