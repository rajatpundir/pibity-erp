...
export const materialReturnSlipItemArea: GridArea = new GridArea('materialReturnSlipItemArea')
    ...
    main: validateLayout({
        ...
        layout_mobile: {
            ...
            areas: Vector.of(
                ...
                Vector.of(details),
                Vector.of(button),
Vector.of(materialReturnSlipItemArea)
...
Vector.of(materialReturnSlipItemArea, materialReturnSlipItemArea)
...
Vector.of(materialReturnSlipItemArea, materialReturnSlipItemArea, materialReturnSlipItemArea)
...
Vector.of(none, materialReturnSlipItemArea, materialReturnSlipItemArea, materialReturnSlipItemArea, materialReturnSlipItemArea, none)
