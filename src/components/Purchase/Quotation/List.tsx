...
import { QuotationRow } from '../../../main/rows'
...
function Component(props) {
    ...
    const queriedVariables = useLiveQuery(() => db.quotations.toArray())
    const variables = (queriedVariables ? queriedVariables.map(x => QuotationRow.toVariable(x)) : []).filter(variable => applyFilter(state.query, variable))
