...
import { DiffRow, QuotationRow } from '../../../main/rows'
import { QuotationVariable } from '../../../main/variables'
...
const initialState: State = {
    ...
    offset: 0,
    page: 1,   
    columns: Vector.of(['variableName'], ['values', 'indent'])
}
...
function Component(props) {
    ...
    const rows = useLiveQuery(() => db.quotations.orderBy('variableName').toArray())
    var composedVariables = Vector.of<Immutable<QuotationVariable>>().appendAll(rows ? rows.map(x => QuotationRow.toVariable(x)) : [])
