...
const initialState: State = {
    ...
    offset: 0,
    page: 1,
    columns: Vector.of(['variableName'], ['values', 'materialRejectionSlip'])
}
...
function Component(props) {
    ...
    const variables = useStore(state => state.variables.MaterialReturnSlip).filter(variable => applyFilter(state.query, variable))
