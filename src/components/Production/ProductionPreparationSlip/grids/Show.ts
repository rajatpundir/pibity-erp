...
export const productionPreparationSlipItemArea: GridArea = new GridArea('productionPreparationSlipItemArea')
    ...
    main: validateLayout({
        ...
        layout_mobile: {
            ...
            areas: Vector.of(
                ...
                Vector.of(details),
                Vector.of(button),
Vector.of(productionPreparationSlipItemArea)
...
Vector.of(productionPreparationSlipItemArea, productionPreparationSlipItemArea)
...
Vector.of(productionPreparationSlipItemArea, productionPreparationSlipItemArea, productionPreparationSlipItemArea)
...
Vector.of(none, productionPreparationSlipItemArea, productionPreparationSlipItemArea, productionPreparationSlipItemArea, productionPreparationSlipItemArea, none)
