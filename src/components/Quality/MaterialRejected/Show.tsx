        ...
        switch (action[0]) {
            ...
            case 'items': {
                switch (action[1]) {
                    ...
                    case 'addVariable': {
                        state.items.variables = state.items.variables.add(new MaterialRejectionSlipItemVariable(-1, { materialRejectionSlip: new MaterialRejectionSlip(state.items.variable.values.materialRejectionSlip.hashCode()), purchaseInvoiceItem: new PurchaseInvoiceItem(state.items.variable.values.purchaseInvoiceItem.hashCode()), quantity: 0, returned: 0 }))
    ...
    const setVariable = useCallback(async () => {
        if (props.match.params[0]) {
            ...
            if (variables.length() === 1) {
                ...
                const itemRows = await db.MaterialRejectionSlipItem.toArray()
                ...
                const items = composedItemVariables.filter(variable => variable.values.materialRejectionSlip.hashCode() === props.match.params[0])
