...
import { MaterialRejectionSlipRow } from '../../../main/rows'
...
function Component(props) {
    ...
    const queriedVariables = useLiveQuery(() => db.materialRejectionSlips.toArray())
    const variables = (queriedVariables ? queriedVariables.map(x => MaterialRejectionSlipRow.toVariable(x)) : []).filter(variable => applyFilter(state.query, variable))
