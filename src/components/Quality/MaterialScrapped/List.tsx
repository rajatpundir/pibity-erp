...
import { ScrapMaterialSlipRow } from '../../../main/rows'
...
function Component(props) {
    ...
    const queriedVariables = useLiveQuery(() => db.scrapMaterialSlips.toArray())
    const variables = (queriedVariables ? queriedVariables.map(x => ScrapMaterialSlipRow.toVariable(x)) : []).filter(variable => applyFilter(state.query, variable))
