...
const initialState: State = {
    ...
    offset: 0,
    page: 1,
    columns: Vector.of<string>('productionPreparationSlip', 'quantity')
}
...
function Component(props) {
    ...
    const variables = useStore(state => state.variables.ScrapMaterialSlip).filter(variable => applyFilter(state.query, variable))
