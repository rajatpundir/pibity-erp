...
function Component(props) {
    ...
    const rows = useLiveQuery(() => db.MaterialApprovalSlip.orderBy('id').toArray())
    ...
    return (
        <Container area={none} layout={Grid.layouts.main} className='p-10'>
            <Item area={Grid.header} align='center' className='flex'>
                ...
                <button onClick={() => { props.history.push('/material-approval-slip') }} className='text-3xl font-bold text-white bg-gray-800 rounded-md px-2'>+</button>
            </Item>
