...
export const materialApprovalSlipItemArea: GridArea = new GridArea('materialApprovalSlipItemArea')
    ...
    main: validateLayout({
        ...
        layout_mobile: {
            ...
            areas: Vector.of(
                ...
                Vector.of(details),
                Vector.of(button),
Vector.of(materialApprovalSlipItemArea)
...
Vector.of(materialApprovalSlipItemArea, materialApprovalSlipItemArea)
...
Vector.of(materialApprovalSlipItemArea, materialApprovalSlipItemArea, materialApprovalSlipItemArea)
...
Vector.of(none, materialApprovalSlipItemArea, materialApprovalSlipItemArea, materialApprovalSlipItemArea, materialApprovalSlipItemArea, none)
