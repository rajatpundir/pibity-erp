...
import { DiffRow, MaterialApprovalSlipRow } from '../../../main/rows'
import { MaterialApprovalSlipVariable } from '../../../main/variables'
...
function Component(props) {
    ...
    const rows = useLiveQuery(() => db.MaterialApprovalSlip.orderBy('variableName').toArray())
