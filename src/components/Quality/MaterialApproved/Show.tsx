...
type State = Immutable<{
    ...
    items: {
        ...
        variables: HashSet<MaterialApprovalSlipItemVariable>
    }
}>
...
const initialState: State = {
    ...
    items: {
        ...
        offset: 0,
        page: 1,
        columns: Vector.of(['values', 'purchaseInvoiceItem'], ['values', 'quantity'], ['values', 'requisted']),
...
function Component(props) {
    ...
    const materialApprovalSlipVariables = useStore(state => state.variables.MaterialApprovalSlip.filter(x=> x.variableName.toString() === props.match.params[0]))
    dispatch(['replace', 'variable', materialApprovalSlipVariables[0]])
        ...
        <>
            <Container area={none} layout={Grid.layouts.main}>
                <Item area={Grid.header}>
                    <Title>Create {materialApprovalSlip.name}</Title>
                </Item>
                ...
                <Container area={Grid.uom} layout={Grid2.layouts.main}>
                    ...
                    <Item area={Grid2.filter} justify='end' align='center' className='flex'>
                        ...
                        <Drawer open={itemFilter} onClose={() => toggleItemFilter(false)} anchor={'right'}>
                            <Filter typeName='MaterialApprovalSlipItem' query={state['items'].query} updateQuery={updateQuery('items')} />
                        </Drawer>
                    </Item>
