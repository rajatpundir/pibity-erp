...
export const materialRejectionSlipItemArea: GridArea = new GridArea('materialRejectionSlipItemArea')
    ...
    main: validateLayout({
        ...
        layout_mobile: {
            ...
            areas: Vector.of(
                ...
                Vector.of(details),
                Vector.of(button),
Vector.of(materialRejectionSlipItemArea)
...
Vector.of(materialRejectionSlipItemArea, materialRejectionSlipItemArea)
...
Vector.of(materialRejectionSlipItemArea, materialRejectionSlipItemArea, materialRejectionSlipItemArea)
...
Vector.of(none, materialRejectionSlipItemArea, materialRejectionSlipItemArea, materialRejectionSlipItemArea, materialRejectionSlipItemArea, none)
