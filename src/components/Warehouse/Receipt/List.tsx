...
import { WarehouseAcceptanceSlipRow } from '../../../main/rows'
...
function Component(props) {
    ...
    const variables = (queriedVariables ? queriedVariables.map(x => WarehouseAcceptanceSlipRow.toVariable(x)) : []).filter(variable => applyFilter(state.query, variable))
